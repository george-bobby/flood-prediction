    ...
    <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-8">
          {['/results/1.png', '/results/2.png', '/results/3.png', '/results/4.png', '/results/5.png', '/results/6.png', '/results/7.png'].map((imgSrc, index) => (
            <ImageCard key={index} src={imgSrc} alt={`Result Graph ${index + 1}`} />
          ))}
        </div>
      </div>
    </div>
